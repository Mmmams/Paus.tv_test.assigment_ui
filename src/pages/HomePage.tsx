...
import {marketplaceAbi, marketplaceAddress, tokenAbi, tokenAddress,} from '../constants';
    ...
    return (
        <>
            {isLoading ? (
                ...
                <div
                    className='flex w-screen flex-column bg-gradient-to-r from-sky-500 to-purple-500 home-container flex-wrap justify-center items-center pl-5'>
                    {latestID > 0 ? (
